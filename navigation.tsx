...
import { Menu, Globe, ChevronDown, LayoutDashboard, LogOut } from "lucide-react";
...
// Only English and German are active for now.
// To add more languages later: add a new entry here AND add the locale
// to the `locales` array in i18n.ts (plus create messages/<code>.json).
const languages = [
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
            ...
            {!loading && user ? (
              <>
                ...
                <Button
                  onClick={signOut}
                  variant="ghost"
                  className="text-white/60 hover:text-red-400 hover:bg-red-400/10 flex items-center gap-2"
                >
          ...
          <Sheet>
            ...
            <SheetContent
              side="right"
              className="w-[300px] bg-[#071424] border-white/10"
            >
