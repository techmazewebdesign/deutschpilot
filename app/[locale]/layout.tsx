    ...
    "@graph": [
      {
        ...
        name: "DeutschPilot",
        alternateName: "Deutsch Pilot",
        url: siteUrl,
        logo: `${siteUrl}/Images/Deurschpilot_logo.png`,
        email: "info@deutschpilot.de",
        address: {
          "@type": "PostalAddress",
          streetAddress: "ul. Ksawerów 3",
          postalCode: "02-656",
