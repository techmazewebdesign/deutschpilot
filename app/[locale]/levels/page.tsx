...
export async function generateMetadata({ params }: { params: { locale: string } }): Promise<Metadata> {
  const t = await getTranslations({ locale: params.locale, namespace: "levelsPage" });
  return { alternates: pageAlternates(params.locale, "/levels"),
    title: t("metaTitle"),
...
const LEVELS: {
  ...
  { key: "A1", rooms: 6, color: "#22c55e", active: true },
  { key: "A2", rooms: 6, color: "#84cc16", active: true },
  { key: "B1", rooms: 6, color: "#E0B873", active: true },
  { key: "B2", rooms: 6, color: "#f97316", active: true },
  { key: "C1", rooms: 6, color: "#a855f7", active: true },
];
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-4 mt-3">
                          <div className="flex items-center gap-1.5 text-xs text-white/35">
                            ...
                            <span>{t("roomsCount", { count: level.rooms })}</span>
                          </div>
                          {level.active && (
                            <div className="flex items-center gap-1.5 text-xs text-white/35">
