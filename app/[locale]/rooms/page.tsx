...
const ROOM_META: Record<Level, { slug: string; icon: React.ElementType; titleDE: string; titleEN: string; descDE: string; descEN: string }[]> = {
  A1: [
    ...
    { slug: "a1-shopping", icon: ShoppingBag, titleDE: "Einkaufen & Alltag", titleEN: "Shopping & Daily Needs", descDE: "Im Supermarkt, Preise verstehen, nach Produkten fragen.", descEN: "At the supermarket, understand prices, ask for products." },
